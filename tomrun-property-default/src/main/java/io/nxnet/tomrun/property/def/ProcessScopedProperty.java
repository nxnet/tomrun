...
public class ProcessScopedProperty implements Property {

    protected final Property property;

    protected final ResolveStrategy resolveStrategy;

    protected final CachedValue<RunContext, String> processValues;

    public ProcessScopedProperty(Property property) 
    {
        this.property = property;
        this.resolveStrategy = ResolveStrategy.PER_PROCESS;
        this.processValues = new InProcessCachedValue<RunContext, String>();
    }
    ...
    public String getValue(final RunContext runContext) throws PropertyException 
    {
        ...
        try
        {
            return this.processValues.getValue(processRunContext, new ValueInitializationStrategy<String>() {
